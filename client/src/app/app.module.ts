...
import { TagWriteValueComponent } from './device/tag-write-value/tag-write-value.component';
...
import { DeviceTreeComponent } from './device/device-tree/device-tree.component';
import { DeviceTreeColumnSettingsComponent } from './device/device-tree/device-tree-column-settings/device-tree-column-settings.component';
...
import { ChangeReferencesComponent } from './editor/change-references/change-references.component';
...
import { HtmlImageListComponent } from './gauges/controls/html-imagelist/html-imagelist.component';
...
import { HtmlAlarmListComponent } from './gauges/controls/html-alarm-list/html-alarm-list.component';
import { AlarmListGaugeComponent } from './gauges/controls/html-alarm-list/alarm-list/alarm-list.component';
import { AlarmListPropertyComponent } from './gauges/controls/html-alarm-list/alarm-list-property/alarm-list-property.component';
import { AlarmListGroupsComponent } from './gauges/controls/html-alarm-list/alarm-list-groups/alarm-list-groups.component';
...
import { TagPropertyOptionsComponent } from './device/tag-property/tag-property-options/tag-property-options.component';
...
@NgModule({ declarations: [
        ...
        DeviceMapComponent,
        DeviceTreeComponent,
        DeviceTreeColumnSettingsComponent,
        FuxaViewComponent,
        ...
        DataTableComponent,
        AlarmListGaugeComponent,
        AlarmListPropertyComponent,
        AlarmListGroupsComponent,
