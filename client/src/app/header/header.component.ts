...
export class HeaderComponent implements AfterViewInit, OnDestroy {
    ...
    /**
     * Notify all clients that the project has been updated
     */
    onNotifyProjectUpdate() {
        console.log('[Header] Notify project update clicked');
        this.hmiService.notifyProjectUpdate();
    }
}
