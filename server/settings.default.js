...
module.exports = {
    ...
    // 'sqlite' (default) -- uses separate SQLite files per module (backward compatible)
    // 'mysql' -- uses a single MySQL database for all modules
    // 'mssql' -- uses a single SQL Server database for all modules
    dbType: 'sqlite',

    // MySQL connection configuration (only used when dbType is 'mysql')
    mysql: {
        host: 'localhost',
        port: 3306,
        user: 'fuxa',
    ...
    // SQL Server connection configuration (only used when dbType is 'mssql')
    mssql: {
        host: 'localhost',
        port: 1433,
        user: 'sa',
